    ...
    <div className="rounded-2xl bg-slate-900/80 border border-slate-800 p-4 sm:p-5 shadow-xl space-y-4">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-white tracking-wide">Audit Trail & DPDP Compliance</h3>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
        ...
        <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1.5 font-mono">
          <div className="flex justify-between text-slate-400">
            ...
            <span className="text-slate-200 font-bold truncate max-w-[180px]">{requestId}</span>
          </div>
          <div className="flex justify-between text-slate-400">
            <span>Arbitration Tier:</span>
            <span className="uppercase text-brand-300 font-bold">{tier}</span>
          </div>
          <div className="flex justify-between text-slate-400">
            <span>Human Review Req:</span>
            <span className={needs_human_review ? 'text-rose-400 font-bold' : 'text-emerald-400 font-bold'}>
        ...
        <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1.5 text-[11px]">
          ...
          {ttl_for_raw_retention && (
            <div className="font-mono text-[10px] text-slate-500 truncate pt-1 border-t border-slate-800">
      ...
      <div className="p-3 rounded-xl bg-slate-950 border border-slate-800/80 space-y-1">
        ...
        <p className="text-xs font-mono text-slate-300 bg-slate-900/60 p-2 rounded-lg border border-slate-800/60 break-words">
          {raw_address}
        </p>
      </div>
      ...
      <div className="border-t border-slate-800 pt-2">
        ...
        {showFullJson && (
          <pre className="mt-2 p-3 rounded-xl bg-slate-950 border border-slate-800 text-[11px] font-mono text-cyan-300 overflow-x-auto max-h-60">
