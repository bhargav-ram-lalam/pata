    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Resolutions flagged with <code className="text-rose-300">needs_human_review=true</code> awaiting operator action.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-xs text-slate-300">
            <div className={`h-2 w-2 rounded-full ${metrics.backendHealthy ? 'bg-emerald-400 animate-pulse' : 'bg-rose-500'}`} />
          ...
          <button
            onClick={onRefresh}
            disabled={isLoading}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-xs font-semibold text-slate-200 transition-colors shadow-sm disabled:opacity-50"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="p-4 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-lg space-y-1">
          ...
          <p className="text-[10px] text-slate-500 font-mono">pata_review_queue_size</p>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-lg space-y-1">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-[11px] text-emerald-400/80 font-medium">auto-verified</span>
          </div>
          <p className="text-[10px] text-slate-500 font-mono">outcome="confirmed"</p>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-lg space-y-1">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-[11px] text-cyan-400/80 font-medium">fine-tune rows</span>
          </div>
          <p className="text-[10px] text-slate-500 font-mono">outcome="corrected"</p>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-lg space-y-1">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-[11px] text-purple-400/80 font-medium">SLA</span>
          </div>
          <p className="text-[10px] text-slate-500 font-mono">pata_review_turnaround</p>
        </div>
